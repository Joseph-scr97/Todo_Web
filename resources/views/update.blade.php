            ...
            <div class="card-body">
                <form method="post" action=" {{route('update', $todo) }}">
                    ...
                    <div class="form-group">
                        ...
                        @if($errors -> has('title')) <span class="invalid-feedback">
                            {{ $errors -> first('title') }}</span> @endif
                    </div>
                    <div class="form-group">
                        <label for="description"> Description </label>
                        <textarea name="description" id="description" rows="5"
                            class="form-control @if($errors -> has('description')) is-invalid @endif"> {{ $todo->description }} </textarea>
                        @if($errors -> has('description')) <span class="invalid-feedback">
